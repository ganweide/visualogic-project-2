...
const membersSchema = new mongoose.Schema({
    MB_registration_date: { type: String, required: true },
    MB_status_new: { type: String, required: true },
    MB_preferred_branch: {type: String,required: true },  
    MB_payment_method: { 
        type: String, 
    ...
    MB_dob: { type: String, required: true },
    ...
    MB_postcode: { type: String, required: true },
    ...
    MB_suggested_by: { 
        ...
        required: true },  
    MB_MC_medical_history: { type: String },
