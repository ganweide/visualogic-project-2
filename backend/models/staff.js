...
const staffSchema = new mongoose.Schema({
  ...
  branchName: { type: mongoose.Schema.Types.ObjectId, ref: 'branch', required: true },
  roleName: { type: mongoose.Schema.Types.ObjectId, ref: 'roles', required: true },
  staffJoinDate: { type: Date, required: true },
