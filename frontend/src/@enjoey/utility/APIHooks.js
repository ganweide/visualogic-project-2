...
// import jwtAxios from '@enjoey/services/ApiConfig';
import jwtAxios from '@enjoey/services/auth/jwt-auth';
      ...
      jwtAxios
        ...
        .catch((error) => {
          if (error.code === 'ERR_NETWORK') {
            console.log(initialUrl, error.message);
...
export const postDataApi = (
  ...
  return new Promise((resolve, reject) => {
    ...
    jwtAxios
      .post(
        url,
        isSanitizeData ? sanitizeData(payload) : payload,
        headers ? {headers} : {},
      )
      .then((data) => {
